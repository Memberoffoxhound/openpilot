#!/usr/bin/env python3
"""
Weather Lady alpha for S3XYPilot / openpilot on Comma 4.
Generates personable or aggressive (foul-mouthed + innuendo) spoken forecasts.
Randomized to real-time conditions from Open-Meteo.
"""

import random
from typing import Dict, Any, List

# WMO weather codes simplified categories
CLEAR = {0, 1}
CLOUDY = {2, 3}
FOG = {45, 48}
...
# ---------- AGGRESSIVE (foul-mouthed, innuendo, MF'n style) ----------
AGGRESSIVE_OPENERS = [

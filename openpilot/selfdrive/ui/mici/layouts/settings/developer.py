...
class AlphaLongConfirmPage(NavScroller):
  def __init__(self, on_confirm: Callable[[], None]):
    ...
    self._scroller.add_widgets([
      ...
      GreyBigButton("", "On this car, Sexypilot defaults to the stock system's built-in ACC."),
      GreyBigButton("", "Enabling this will switch to Sexypilot longitudinal control."),
      GreyBigButton("", "Using Experimental mode is recommended with Sexypilot longitudinal control alpha."),
      GreyBigButton("", "Changing this setting will restart Sexypilot if the car is powered on."),
      accept,
    ])

...
from openpilot.selfdrive.ui.layouts.settings.common import THEME_TESLA_RGB, THEME_OPENPILOT_RGB
...
LANE_LINE_COLORS = {
  ...
  UIStatus.ENGAGED: STOCK_LANE_GREEN,
}
  ...
  def _get_ll_color(self, prob: float, adjacent: bool, left: bool):
    ...
    if adjacent:
      if ui_state.status == UIStatus.ENGAGED:
        _base_color = getattr(self, "_ll_engaged", STOCK_LANE_GREEN)
      else:

...
from openpilot.selfdrive.mads.helpers import MadsSteeringModeOnBrake, read_steering_mode_param, MADS_NO_ACC_MAIN_BUTTON
from openpilot.selfdrive.mads.state import StateMachine, GEARS_ALLOW_PAUSED_SILENT
...
class ModularAssistiveDrivingSystem:
  def __init__(self, selfdrive):
    ...
    self.enabled_toggle = self.params.get_bool("Mads") and bool(self.CP.openpilotLongitudinalControl)
  ...
  def update_events(self, CS: structs.CarState):
    ...
    # Strip long-only user-disable so the lateral SM stays up.

...
| `SoftCruiseReturn` | on | After a pedal overshoot, ease back to set speed instead of a regen bite. Live set-speed increases are honored mid-return. OP long only. |
